...
require_once(_PS_ROOT_DIR_.'/modules/jmsflashsales/jmsflashsales.php');
class JmsflashsalesFlashsalesModuleFrontController extends ModuleFrontController
{
	...
	public function initContent()
	{
		...
		$this->setTemplate('module:jmsflashsales/views/templates/front/flashsales.tpl');
	}
}
