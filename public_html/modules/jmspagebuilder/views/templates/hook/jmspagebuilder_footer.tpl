		...
		<form action="index.php" method="POST">
			...
			<div class="form-group">
				<label class="form-label">Theme Skin</label>
					...
					<img src="themes/{$themename nofilter}/assets/img/skin-icons/default.png" alt="Default" />
					</a>
				{foreach from=$themeskins item=sk}
					<a class="skin-box {if $jpb_skin== $sk}active{/if}" title="{$sk nofilter}" data-color="{$sk nofilter}">
					<img src="themes/{$themename nofilter}/assets/img/skin-icons/{$sk nofilter}.png" alt="{$sk nofilter}" />
					</a>
				{/foreach}
			</div>
			{/if}
