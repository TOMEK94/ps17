...
<div class="jms-slider-wrapper">
	<div class="responisve-container">
		...
		{foreach from=$slides item=slide}
			<div class="slide {$slide.class_suffix|escape:'htmlall':'UTF-8'}" style="{if $slide.bg_type}background:url({$image_url|escape:'htmlall':'UTF-8'}slides/{$slide.bg_image|escape:'htmlall':'UTF-8'}) no-repeat left top;background-size:cover;{else}background:{$slide.bg_color|escape:'htmlall':'UTF-8'}{/if}" {if $slide.slide_link}onclick="document.location='{$slide.slide_link|escape:'htmlall':'UTF-8'}';"{/if}>
