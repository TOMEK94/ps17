...
class PHPExcel_CachedObjectStorage_SQLite3 extends PHPExcel_CachedObjectStorage_CacheBase implements PHPExcel_CachedObjectStorage_ICache
{
    ...
    public function copyCellCollection(PHPExcel_Worksheet $parent)
    {
        ...
        if (!$this->DBHandle->exec('CREATE TABLE IF NOT EXISTS kvp_'.$tableName.' (id VARCHAR(12) PRIMARY KEY, value BLOB)
    ...
    public function __construct(PHPExcel_Worksheet $parent)
    {
        ...
        if (is_null($this->DBHandle)) {
            ...
            if (!$this->DBHandle->exec('CREATE TABLE IF NOT EXISTS kvp_'.$this->TableName.' (id VARCHAR(12) PRIMARY KEY, value BLOB)')) {
                throw new PHPExcel_Exception($this->DBHandle->lastErrorMsg());
            }
        }
    ...
    {
        if (!is_null($this->DBHandle)) {
            $this->DBHandle->exec('DROP TABLE IF EXISTS kvp_'.$this->TableName);
            $this->DBHandle->close();
        }
        $this->DBHandle = null;
    }
