...
class pmcvgprivacymanagementModuleFrontController extends ModuleFrontController
{
    public $auth = true;
    public $ssl = true;
    ...
    public function initContent()
    {
        ...
        $this->setTemplate('module:pmcvg/views/templates/front/privacymanagement.tpl');
