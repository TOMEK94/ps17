    ...
    <div class='advance_content panel'>
        ...
        <h3>{l s='Upload Excel File' mod='ba_importer'}</h3>
            ...
            <div class="form-group">
                ...
                {*<select class="import_items" id="select_settings" name='select_settings'>
                    {foreach from=$select_is key=key_select_is item=item_select_is}
                        <option id="select_settings_{$select_is[$key_select_is]['id_importer_config']|escape:'htmlall':'UTF-8'}" {if $arr_confign_bc1.select_settings == {$select_is[$key_select_is]['id_importer_config']|escape:'htmlall':'UTF-8'}}selected{/if} value={$select_is[$key_select_is]['id_importer_config']|escape:'htmlall':'UTF-8'}>{l s={$select_is[$key_select_is]['ba_name_setting']|escape:'htmlall':'UTF-8'} mod='ba_importer'}</option>
                    {/foreach}
                    <option id="select_settings_other" value='other'>{l s='Other...' mod='ba_importer'}</option>
                </select>*}
            ...
            <div class="form-group upload_file" id="form_import_ftp" {if $arr_confign_bc1.import_local == '2'}style="display:block"{/if}>
                ...
                <div class="items_to_import_ftp">
                    ...
                    <input type="text" class="form-control" id="ftp_server" name="ftp_server" value="{$arr_confign_bc1.ftp_server|escape:'htmlall':'UTF-8'}" placeholder="Address of FTP server"/>
                    <input type="text" class="form-control" id="ftp_user_name" name="ftp_user_name" value="{$arr_confign_bc1.ftp_user_name|escape:'htmlall':'UTF-8'}" placeholder="Username"/>
                    <input type="password" class="form-control" id="ftp_user_pass"  name="ftp_user_pass" value="{$arr_confign_bc1.ftp_user_pass|escape:'htmlall':'UTF-8'}" placeholder="Password"/>
            ...
            <div class="form-group advance_button">
                ...
                <div class="items_to_import">
                    ...
                    <button type="submit" class="btn btn-default btn-sm" name="submitimport" onclick="return basubmitimport()">{l s='Next step' mod='ba_importer'}</button>
