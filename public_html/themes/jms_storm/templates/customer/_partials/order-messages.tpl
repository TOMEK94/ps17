...
<section class="order-message-form box">
  <form action="{$urls.pages.order_detail}" method="post">
    ...
    <header>
      <h3>{l s='Wyślij wiadomość' d='Shop.Theme.CustomerAccount'}</h3>
      <p>{l s='Jeśli chcesz dodać komentarz do swojego zamówienia, napisz do nas używając formularza poniżej.' d='Shop.Theme.CustomerAccount'}</p>
    </header>
