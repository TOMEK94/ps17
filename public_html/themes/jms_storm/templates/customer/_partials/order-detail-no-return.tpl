  ...
  <table id="order-products" class="table table-bordered">
    <thead class="thead-default">
      <tr>
        ...
        <th class="order-title">{l s='Product info' d='Shop.Theme.Catalog'}</th>
        <th class="order-title">{l s='Quantity' d='Shop.Theme.Catalog'}</th>
        <th class="order-title">{l s='Unit price' d='Shop.Theme.Catalog'}</th>
        <th class="order-title">{l s='Total price' d='Shop.Theme.Catalog'}</th>
      </tr>
    </thead>
