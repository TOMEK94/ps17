...
{block name='page_content'}
      ...
      <div class="box">
          <div class="row">
            <div class="col-md-{if $order.details.reorder_url}9{else}12{/if} col-xs-12">
              <strong>
                {l
                  s='Numer zamówienia %reference% - złożone dnia %date%'
      ...
      <div class="box">
          <ul>
            ...
            {if $order.details.invoice_url}
              <li>
                <a href="{$order.details.invoice_url}">
                  {l s='Pobierze swoją fakturę w pliku PDF.' d='Shop.Theme.CustomerAccount'}
                </a>
              </li>
            {/if}
            ...
            {if $order.details.recyclable}
              <li>
                {l s='Wyraziłeś zgodę na opakowanie produktu w opakowanie ekologiczne' d='Shop.Theme.CustomerAccount'}
              </li>
            {/if}
  ...
  {block name='order_history'}
    <section id="order-history" class="box">
      <h3>{l s='Śledź swoje zamówienie krok po kroku' d='Shop.Theme.CustomerAccount'}</h3>
      <table class="table table-striped table-bordered table-labeled hidden-xs-down">
        <thead class="thead-default">
          <tr>
            <th>{l s='Data' d='Shop.Theme'}</th>
        ...
        <div class="hidden-md-up shipping-lines">
          {foreach from=$order.shipping item=line}
            <div class="shipping-line">
              <ul>
                <li>
                  <strong>{l s='Data' d='Shop.Theme'}</strong> {$line.shipping_date}
                </li>
                <li>
