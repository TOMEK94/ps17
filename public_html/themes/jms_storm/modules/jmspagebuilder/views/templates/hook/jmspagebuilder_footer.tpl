		...
		<form action="index.php" method="POST">
			...
			<div class="form-group">
				<label class="form-label">Theme Skin</label>
					...
					<img src="themes/{$themename|escape:'htmlall':'UTF-8'}/assets/img/skin-icons/default.png" alt="Default" />
					</a>
				{foreach from=$themeskins item=sk}
					...
					<img src="themes/{$themename|escape:'htmlall':'UTF-8'}/assets/img/skin-icons/{$sk|escape:'htmlall':'UTF-8'}.png" alt="{$sk|escape:'htmlall':'UTF-8'}" />
					</a>
				{/foreach}
			</div>
			{/if}
